    ...
    <div className="game-shell relative flex min-h-0 flex-col overflow-hidden bg-bg text-fg">
      ...
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-3xl flex-1 flex-col justify-end gap-5 overflow-y-auto overscroll-contain px-5 pb-10 pt-12 sm:justify-center sm:pb-16">
        <header className="space-y-2">
          ...
          <h1 className="font-sans text-4xl font-medium tracking-tight text-paper sm:text-6xl">{t(locale, "meta.title")}</h1>
          ...
          <section className="rounded-md border border-olive/40 bg-surface/90 p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <Button onClick={() => load()} className="min-h-11">
                <Play /> {t(locale, "start.continue")} · {t(locale, `hat.${brief.hat}.title`)} T{brief.turn}
              </Button>
